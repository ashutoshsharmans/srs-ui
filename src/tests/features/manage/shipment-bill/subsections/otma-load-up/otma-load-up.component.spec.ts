...
import { IOtmaLoadUpFG } from '@otc/features/manage/shipment-bill/models/shipment-bill.interface';
...
describe('Otma Load Up Component', () => {
  let component: OtmaLoadUpComponent;
  let componentRef: ComponentRef<OtmaLoadUpComponent>;
  let fixture: ComponentFixture<OtmaLoadUpComponent>;

  const form: FormGroup<IOtmaLoadUpFG> = new FormGroup({
    otma: new FormControl()
  }) as unknown as FormGroup<IOtmaLoadUpFG>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(OtmaLoadUpComponent);
