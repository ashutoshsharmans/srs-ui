...
import { IGeneralSetupFG } from '@otc/features/manage/shipment-bill/models/shipment-bill.interface';
...
describe('General Setup Component', () => {
  let component: GeneralSetupComponent;
  let componentRef: ComponentRef<GeneralSetupComponent>;
  let fixture: ComponentFixture<GeneralSetupComponent>;

  const form: FormGroup<IGeneralSetupFG> = new FormGroup({
    searchBy: new FormControl(),
    serialNumber: new FormControl()
  }) as unknown as FormGroup<IGeneralSetupFG>;
