...
const config: Config = {
  ...
  // cacheDirectory: "C:\\Users\\zd4eu\\AppData\\Local\\Temp\\jest",
  ...
  moduleNameMapper: {
    '^@otc/(.*)': '<rootDir>/src/app/$1',
    '^@otc/core/(.*)': '<rootDir>/src/app/core/$1',
    '^@otc/features/(.*)': '<rootDir>/src/app/features/$1',
    '^@otc/shared/(.*)': '<rootDir>/src/app/shared/$1',
    '^@otc/tests/(.*)': '<rootDir>/src/tests/$1'
  },
  ...
  testPathIgnorePatterns: [
    ...
    '<rootDir>/src/app/shared/services/launch-darkly.service.ts'
  ]
